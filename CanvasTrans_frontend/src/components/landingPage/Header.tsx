...
export default function Header({ toggleDarkMode, isDarkMode }: HeaderProps) {
  ...
  return (
    <header className={`sticky top-0 z-50 transition-all duration-300 bg-background dark:bg-gray-700 text-gray-800 ${isScrolled ? 'backdrop-blur-md border-b border-gray-200 dark:border-gray-800' : ''}`}>
